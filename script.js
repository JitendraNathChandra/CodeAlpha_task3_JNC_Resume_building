...
function generateResume(){
 ...
 let emailfiled = document.getElementById('emailfiled').value;
 
 document.getElementById('emailTemplate').setAttribute('href',emailfiled);
 document.getElementById('emailTemplate').innerHTML = emailfiled;

 let twitterfiled = document.getElementById('twitterfiled').value;
 
 document.getElementById('twitterTemplate').setAttribute('href',twitterfiled);
 document.getElementById('twitterTemplate').innerHTML = twitterfiled;
